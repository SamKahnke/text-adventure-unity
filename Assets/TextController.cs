...
public class TextController : MonoBehaviour {
	...
	void lock_1 () {
		...
		if 		(Input.GetKeyDown(KeyCode.O)) 	{currentState = States.corridor_0;}
	...
	void corridor_0 () {
		...
		if 		(Input.GetKeyDown(KeyCode.S)) 	{currentState = States.stairs_0;}
		else if (Input.GetKeyDown(KeyCode.F)) 	{currentState = States.floor;}
		else if (Input.GetKeyDown(KeyCode.C)) 	{currentState = States.closet_door;}  
	}
}